...
export default async (req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      error: `Did you input your email properly? Are you sure you haven't already registered? So many questions. Feel free to msg me oo@noadjective.com`,
    });
...
// https://www.youtube.com/watch?v=Rzlop3Bgk1Q
// https://github.com/uriklar/uriklar-next/blob/master/pages/index.jsx
